...
class LadderGameTest {
    ...
    void 사다리_사람_예외_처리_확인() {
        ...
        //given
        Position nthOfPerson = Position.of(4);

        //then
        assertThrows(IllegalArgumentException.class, ()->ladderGame.run(nthOfPerson));
    }
    ...
    void 사다리_결과_확인() {
        ...
        //given
        Position nthOfPerson = Position.of(0);

        //then
        assertEquals(2, ladderGame.run(nthOfPerson));

        //given
        nthOfPerson = Position.of(1);

        //then
        assertEquals(1, ladderGame.run(nthOfPerson));

        //given
        nthOfPerson = Position.of(2);
